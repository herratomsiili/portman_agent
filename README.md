...
| **`STORAGE_ACCOUNT_NAME`** | Name of Azure Storage Account to be created (`NAMING_PREFIX` _can not be used here because there are stricter naming validation rules for Azure storage accounts)_ |
...
- Install Python (_currently Azure Functions support Python version < 3.13_)
